    ...
    <div>
      ...
      <div className="flex flex-col gap-2">
        ...
        <div className="sticky top-0 z-50 flex items-center justify-between px-4 md:px-10 h-20 bg-[#ec008c] text-white rounded-b-[40px] text-[13px] font-semibold">
          ...
          {/* Mobile Side Menu */}
          <div
            className={`h-screen w-[75%] md:w-[30%] bg-[#005fa7] fixed left-0 top-0 z-50 shadow-2xl transform transition-transform duration-300 ease-in-out ${
        ...
        <div
          className={`h-screen w-[75%] md:w-[30%] bg-[#005fa7] fixed right-0 top-0 z-50 shadow-2xl transform transition-transform duration-300 ease-in-out ${
          ...
          <div className="w-full bg-[#f2ef12] py-2 px-6 text-black">
            ...
            <div className="py-3">
              ...
              <div className="flex flex-col w-full justify-center items-center text-[12px]">
                <p>© 2025, Mindstrips Powered by React</p>
